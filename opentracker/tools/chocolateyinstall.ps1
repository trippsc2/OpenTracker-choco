...
$url64      = 'https://github.com/trippsc2/OpenTracker/releases/download/1.7.0/OpenTracker.1.7.0.win-x86.msi'
...
$packageArgs = @{
  ...
  checksumType  = 'sha256'
  checksum64    = '508EA16CB22871DEC61D4C4BE252F0C028ED3069080F65B2C9C0B741651E5323'
